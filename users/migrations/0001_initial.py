# Generated by Django 4.2.2 on 2023-07-01 04:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Author',
            fields=[
                ('author_id', models.PositiveIntegerField(primary_key=True, serialize=False, verbose_name='ID автора')),
                ('author_name', models.CharField(max_length=150, verbose_name='Ник')),
